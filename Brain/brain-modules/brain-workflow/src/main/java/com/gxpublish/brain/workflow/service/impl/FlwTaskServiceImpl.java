...
import com.gxpublish.brain.workflow.domain.bo.*;
import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import com.gxpublish.brain.common.core.domain.dto.StartProcessReturnDTO;
import com.gxpublish.brain.common.core.domain.dto.UserDTO;
...
import com.gxpublish.brain.common.core.service.UserService;
import com.gxpublish.brain.common.core.utils.StreamUtils;
import com.gxpublish.brain.common.core.utils.StringUtils;
import com.gxpublish.brain.common.core.utils.ValidatorUtils;
...
import com.gxpublish.brain.workflow.common.enums.TaskAssigneeType;
import com.gxpublish.brain.workflow.common.enums.TaskStatusEnum;
import com.gxpublish.brain.workflow.domain.FlowInstanceBizExt;

import com.gxpublish.brain.workflow.domain.vo.FlowCopyVo;
import com.gxpublish.brain.workflow.domain.vo.FlowHisTaskVo;
import com.gxpublish.brain.workflow.domain.vo.FlowTaskVo;
import com.gxpublish.brain.workflow.domain.vo.NodeExtVo;
import com.gxpublish.brain.workflow.mapper.FlwCategoryMapper;
import com.gxpublish.brain.workflow.mapper.FlwInstanceBizExtMapper;
import com.gxpublish.brain.workflow.mapper.FlwTaskMapper;
import com.gxpublish.brain.workflow.service.IFlwCommonService;
import com.gxpublish.brain.workflow.service.IFlwNodeExtService;
import com.gxpublish.brain.workflow.service.IFlwTaskAssigneeService;
import com.gxpublish.brain.workflow.service.IFlwTaskService;
import org.springframework.stereotype.Service;
import org.springframework.transaction.annotation.Transactional;

import java.util.*;

import static com.gxpublish.brain.workflow.common.constant.FlowConstant.*;
...
public class FlwTaskServiceImpl implements IFlwTaskService {
    ...
    public List<FlowTask> selectByInstId(Long instanceId) {
        return flowTaskMapper
                .selectList(new LambdaQueryWrapper<>(FlowTask.class).eq(FlowTask::getInstanceId, instanceId));
    }
    ...
    public List<FlowTask> selectByInstIds(List<Long> instanceIds) {
        return flowTaskMapper
                .selectList(new LambdaQueryWrapper<>(FlowTask.class).in(FlowTask::getInstanceId, instanceIds));
    }
    ...
    public boolean isTaskEnd(Long instanceId) {
        boolean exists = flowTaskMapper
                .exists(new LambdaQueryWrapper<FlowTask>().eq(FlowTask::getInstanceId, instanceId));
        return !exists;
    }
