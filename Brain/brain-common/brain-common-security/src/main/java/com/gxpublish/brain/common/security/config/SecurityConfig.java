package com.gxpublish.brain.common.security.config;
...
import com.gxpublish.brain.common.core.constant.HttpStatus;
...
import com.gxpublish.brain.common.security.config.properties.SecurityProperties;
import com.gxpublish.brain.common.security.handler.AllUrlHandler;
        ...
        registry.addInterceptor(new SaInterceptor(handler -> {
            ...
            SaRouter
                    ...
                    .check(() -> {
                        ...
                        // CORS Preflight / OPTIONS requests should pass without authentication
