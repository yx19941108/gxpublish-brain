/*
Owner: Codex
Task: manuscript_review release ddl
Status: Draft
Updated: 2026-04-01

Notes:
- This file is intended for the initial release of manuscript_review tables.
- Apply after the platform base SQL is ready.
- If the target environment already contains old manuscript_review tables with live data,
  do not run this file blindly. Compare schema differences first.
*/
